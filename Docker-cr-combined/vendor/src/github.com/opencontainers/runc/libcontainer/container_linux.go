          ...
          if criuOpts.PrevImagesDirectory == "" {     // peter added
			...
			FileLocks:      proto.Bool(criuOpts.FileLocks),
		        ...
		        AutoDedup:      proto.Bool(criuOpts.AutoDedup),  //peter
                        LazyPages:      proto.Bool(criuOpts.LazyPages),   // peter for lazy-pages
                        LazyPagesPort:      proto.Int32(criuOpts.LazyPagesPort),   // peter for lazy-pages
		}
...
func (c *linuxContainer) Restore(process *Process, criuOpts *CriuOpts) error {
	...
	defer c.m.Unlock()
         ...
         fmt.Println("Restore- lazy-page=%s#",criuOpts.LazyPages) // peter
