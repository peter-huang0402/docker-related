...
type CriuOpts struct {
	...
	LazyPages         *bool               `protobuf:"varint,35,opt,name=lazy_pages" json:"lazy_pages,omitempty"`
	LazyPagesPort     *int32              `protobuf:"varint,36,opt,name=lazy_pages_port" json:"lazy_pages_port,omitempty"`
	XXX_unrecognized  []byte              `json:"-"`
}
...
func (m *CriuOpts) GetLazyPagesPort() int32 {
	if m != nil && m.LazyPagesPort != nil {
		return *m.LazyPagesPort
	}
	return 0
}
