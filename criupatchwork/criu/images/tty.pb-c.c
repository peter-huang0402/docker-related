...
static const ProtobufCFieldDescriptor tty_file_entry__field_descriptors[4] =
{
  {
    "id",
    1,
...
static const ProtobufCIntRange tty_file_entry__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 4 }
};
const ProtobufCMessageDescriptor tty_file_entry__descriptor =
{
  ...
  1,  tty_file_entry__number_ranges,
