...
static const ProtobufCFieldDescriptor dump_stats_entry__field_descriptors[10] =
{
  {
    "freezing_time",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_UINT64,
    0,   /* quantifier_offset */
    offsetof(DumpStatsEntry, pages_zero),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
