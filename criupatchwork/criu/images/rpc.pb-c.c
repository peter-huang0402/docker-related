...
static const ProtobufCFieldDescriptor criu_opts__field_descriptors[47] =
{
  {
    "images_dir_fd",
    1,
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_INT32,
    offsetof(CriuOpts, has_lazy_pages_port),
    offsetof(CriuOpts, lazy_pages_port),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned criu_opts__field_indices_by_name[] = {
  ...
  24,   /* field[24] = cg_root */
  43,   /* field[43] = cgroup_dump_controller */
  41,   /* field[41] = cgroup_props */
  42,   /* field[42] = cgroup_props_file */
  19,   /* field[19] = cpu_cap */
  39,   /* field[39] = empty_ns */
  ...
  38,   /* field[38] = external */
  7,   /* field[7] = file_locks */
  20,   /* field[20] = force_irmap */
  44,   /* field[44] = freeze_cgroup */
  36,   /* field[36] = ghost_limit */
  0,   /* field[0] = images_dir_fd */
  26,   /* field[26] = inherit_fd */
  37,   /* field[37] = irmap_scan_paths */
  40,   /* field[40] = join_ns */
  34,   /* field[34] = lazy_pages */
  35,   /* field[35] = lazy_pages_port */
  ...
  46,   /* field[46] = tcp_skip_in_flight */
  45,   /* field[45] = timeout */
...
static const ProtobufCIntRange criu_opts__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 47 }
};
