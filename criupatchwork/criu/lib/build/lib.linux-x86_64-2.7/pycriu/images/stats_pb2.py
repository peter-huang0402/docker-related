...
_DUMP_STATS_ENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pages_zero', full_name='dump_stats_entry.pages_zero', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pages_lazy', full_name='dump_stats_entry.pages_lazy', index=9,
